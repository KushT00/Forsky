...
const ComponentName = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setPaused(prev => !prev);
    }, 2400); // Toggle pause every 0.5 seconds
    ...
    <>
      {/* <div style={marqueeContainerStyle}>
        ...
        <div
          style={{
            ...marqueeContentStyle,
            animationPlayState: paused ? 'paused' : 'running', // Control animation state
          }}
        > */}
          {/* Repeat your content here */}
          {/* {[...Array(100)].map((_, index) => (
            <React.Fragment key={index}>
              <Card className="min-w-[200px] bg-primary text-primary-foreground px-4 py-3 rounded-md mx-2">
                <CardContent className="flex items-center gap-2">
                  <FlagIcon className="h-5 w-5" />
                  <span className="text-sm font-medium">Made in India</span>
                </CardContent>
              </Card>
              <Card className="min-w-[200px] bg-secondary text-secondary-foreground px-4 py-3 rounded-md mx-2">
                <CardContent className="flex items-center gap-2">
                  <TruckIcon className="h-5 w-5" />
                  <span className="text-sm font-medium">Free Shipping, COD</span>
                </CardContent>
              </Card>
              <Card className="min-w-[200px] bg-primary text-primary-foreground px-4 py-3 rounded-md mx-2">
                <CardContent className="flex items-center gap-2">
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img className="w-20 h-19" src={logo} alt="" />

                <p className="text-base leading-relaxed text-gray-600 mt-7">Add Decription.</p>
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-black-600  uppercase">Company</p>
            ...
            <div>
                <p className="text-sm font-semibold tracking-widest text-black-600 uppercase">Help</p>
            ...
            {/* <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p className="text-sm font-semibold tracking-widest text-black-600 uppercase">Connect with Email</p>
                ...
                <form action="#" method="POST" className="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-2 mt-3 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700">Submit</button>
                </form>
            </div> */}
        </div>
