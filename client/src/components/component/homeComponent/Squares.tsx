...
const Squares: React.FC<SquaresProps> = ({
  direction = 'right',
  speed = 1,
  borderColor = '#f0f0f0', // Very light gray for border
  hoverFillColor = '#e0e0e0', // Light gray for hover
}) => {
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      gradient.addColorStop(1, 'rgba(255, 255, 255, 0.5)'); // Semi-transparent white edge
